...
{
    public class ProductServiceV1 : IProductServiceV1
    {
        ...
        public ProductServiceV1(IProductRepository _productRepository)
        {
            try
            {
        ...
        public IEnumerable<Product> GetProducts()
        {
            try
            {
                return productRepository.GetProducts().Where(p => p.ProductVersion == "1.0");
            }
            catch
            {
                throw;
